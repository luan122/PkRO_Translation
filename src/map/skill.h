...
//----------PkRO Skills----------------------
	...
	FIRE_EMBER = 8001,
	NORMAL_HEALAREA = 8002,
	EARTH_EARTHQUAKE = 8003,
	FIRE_MAGMASTORM = 8004,
	LEAF_LEAVESDANCE = 8005,
	NORMAL_HEADBUTT = 8006,
	LEAF_LEAFSTORM = 8007,
	WATER_WATERGUN = 8008,
	WATER_WATERTORNADO = 8009,
	PSY_RECOVER = 8010,
	ICE_ICESPIKES = 8011,
	ICE_BLIZZARD = 8012,
	STONE_ROCKTHROW = 8013,
	STONE_HARDEN = 8014,
	STONE_STONECONCUSSION = 8015,
	FIRE_METEORFLAME = 8016,
	ELETRIC_THUNDERSHOCK = 8017,
	ELETRIC_THUNDERPUNCH = 8018,
	ELETRIC_THUNDERSTORM = 8019,
	FLY_GUST = 8020,
	FLY_WINGATTACK = 8021,
	FLY_TORNADO = 8022,
	DRAGON_DRACOMETEOR = 8023,
	PSY_PSYBEAM = 8024,	
	WATER_HYDROPUMP = 8025,
	PSY_CONFUSION = 8026,
	PSY_PSYCHIC = 8027,
	GHOST_DARKBALL = 8028,
	GHOST_SHADOWPUNCH = 8029,
	NORMAL_QUICKATTACK = 8030,
	GHOST_SHADOWSTORM = 8031,
	FIGHT_EXTREMEAGILITY = 8032,
	FIGHT_RAGE = 8033,
	FIGHT_DEMONKICK = 8034,
	NORMAL_BODYSLAM = 8035,
	NORMAL_REST = 8036,
	NORMAL_MEGAPUNCH = 8037,
	NORMAL_SLEEPPOWER = 8038,
	FIRE_FLAMETHROW = 8039,
	NORMAL_TACKLE = 8040,
	BUG_ABSORV = 8041,
	BUG_TRIPLEBLOW = 8042,
	POISON_POISONATTACK = 8043,
	POISON_POISONGAS = 8044,
