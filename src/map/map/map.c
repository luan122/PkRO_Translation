...
void map_reloadnpc_sub(char *cfgName)
{
	...
	if( fp == NULL )
	{
		ShowError("Arquivo de configuraÁ„o de mapa n„o existe: %s\n", cfgName);
		return;
	}
...
{
	if (clear)
		npc_addsrcfile("clear"); // isto ir· limpar a atual lista de scripts
...
int do_init(int argc, char *argv[])
{
	...
	//N„o reiniciar o arquivo de configuraÁ„o de NPC quando isto ocorrer.
    map_reloadnpc(false);
